...
<div class="container">
    ...
    <button class="btn-add">
        ...
        <a class="add" href="client/add">Ajouter un client</a>
    </button>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div class="btn-group align-top">
                                                        ...
                                                        <button class="btn btn-sm btn-outline-secondary badge" type="button"><a class="text-warning"href="${pageContext.request.contextPath}/client/facture?id=${client.idClient}"/>List des factures</button>
                                                            <form action="/deleteClient?id=${client.idClient}" method="post">
                                                                <button class="btn btn-sm btn-outline-secondary badge text-danger form-button-delete" type="submit" >Supprimer</button>
                                                            </form>
                                                    </div>
                                                </td>
                                            </tr>
